...
def postprocessPredictionAndGT(prediction, GT, device, predictionsmoothing, holefilling):
    ...
    for i in range(1, numberTubuli + 1):
        ...
        if tubuliSelection.sum() < 125:  # remove too small noisy regions
    ...
    for i in range(1, numberTubuli + 1):
        ...
        if tubuliSelection.sum() < 375:  # remove too small noisy regions
    ...
    for i in range(1, numberTubuli + 1):
        ...
        if tubuliSelection.sum() < 5:  # remove too small noisy regions
    ...
    for i in range(1, numberTubuli + 1):
        ...
        if tubuliSelection.sum() < 100:  # remove too small noisy regions
            labelMap[tubuliSelection] = 0
    ...
    for i in range(1, numberTubuli + 1):
        ...
        if tubuliSelection.sum() < 750:  # remove too small noisy regions
            labelMap[tubuliSelection] = 0
